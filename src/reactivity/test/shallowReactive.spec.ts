...
describe('shallowReactive', () => {
    ...
    // #5271
    test.skip('should respect shallow reactive nested inside reactive on reset', () => {
    ...
    test.skip('should respect shallow/deep versions of same target on access', () => {
        const original = {}
    ...
    describe('collections', () => {
        ...
        test.skip('should not observe when iterating', () => {
            const shallowSet = shallowReactive(new Set())
            const a = {}
            shallowSet.add(a)
        ...
        test.skip('should not get reactive entry', () => {
        ...
        test.skip('should not get reactive on foreach', () => {
            const shallowSet = shallowReactive(new Set())
            const a = {}
            shallowSet.add(a)
